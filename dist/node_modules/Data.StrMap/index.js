...
var fromList = function (l) {
    return pureST(function __do() {
        ...
        Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(l)(function (_306) {
            return Data_StrMap_ST.poke(_23)(_306.value0)(_306.value1);
        })();
        return _23;
    });
};
...
var alter = function (f) {
    return function (k) {
        return function (m) {
            var _1402 = f(lookup(k)(m));
            if (_1402 instanceof Data_Maybe.Nothing) {
                return $$delete(k)(m);
            };
            if (_1402 instanceof Data_Maybe.Just) {
                return insert(k)(_1402.value0)(m);
            };
