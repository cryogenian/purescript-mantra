...
var traversableTuple = new Traversable(function () {
    ...
    return function (_98) {
        return Prelude["<$>"]((__dict_Applicative_1["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Tuple.Tuple.create(_98.value0))(_98.value1);
    };
}, function (__dict_Applicative_0) {
    return function (_96) {
        return function (_97) {
            return Prelude["<$>"]((__dict_Applicative_0["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Tuple.Tuple.create(_97.value0))(_96(_97.value1));
        };
    };
});
var traversableMaybe = new Traversable(function () {
    ...
    return function (_95) {
        ...
        if (_95 instanceof Data_Maybe.Just) {
            return Prelude["<$>"]((__dict_Applicative_3["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Maybe.Just.create)(_95.value0);
        };
    ...
    return function (_93) {
        return function (_94) {
            ...
            if (_94 instanceof Data_Maybe.Just) {
                return Prelude["<$>"]((__dict_Applicative_2["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Maybe.Just.create)(_93(_94.value0));
            };
            throw new Error("Failed pattern match");
        };
    };
...
var traversableEither = new Traversable(function () {
    ...
    return function (_92) {
        if (_92 instanceof Data_Either.Left) {
            return Prelude.pure(__dict_Applicative_5)(new Data_Either.Left(_92.value0));
        };
        if (_92 instanceof Data_Either.Right) {
            return Prelude["<$>"]((__dict_Applicative_5["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Either.Right.create)(_92.value0);
        };
        throw new Error("Failed pattern match");
    };
    ...
    return function (_90) {
        return function (_91) {
            if (_91 instanceof Data_Either.Left) {
                return Prelude.pure(__dict_Applicative_4)(new Data_Either.Left(_91.value0));
            };
            if (_91 instanceof Data_Either.Right) {
                return Prelude["<$>"]((__dict_Applicative_4["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Either.Right.create)(_90(_91.value0));
            };
            throw new Error("Failed pattern match");
        };
    };
});
var stateR = function (_86) {
    return _86;
};
var stateL = function (_85) {
    return _85;
};
...
var traversableArray = new Traversable(function () {
    ...
    return function (_89) {
        ...
        if (_89.length >= 1) {
            var _410 = _89.slice(1);
            return Prelude["<*>"](__dict_Applicative_7["__superclass_Prelude.Apply_0"]())(Prelude["<$>"]((__dict_Applicative_7["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Prelude[":"])(_89[0]))(sequence(traversableArray)(__dict_Applicative_7)(_410));
        };
        throw new Error("Failed pattern match");
    };
    ...
    return function (_87) {
        return function (_88) {
            ...
            if (_88.length >= 1) {
                var _414 = _88.slice(1);
                return Prelude["<*>"](__dict_Applicative_6["__superclass_Prelude.Apply_0"]())(Prelude["<$>"]((__dict_Applicative_6["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Prelude[":"])(_87(_88[0])))(traverse(traversableArray)(__dict_Applicative_6)(_87)(_414));
            };
            throw new Error("Failed pattern match");
        };
    };
...
var functorStateR = new Prelude.Functor(function (f) {
    return function (k) {
        return StateR.create(function (s) {
            var _415 = stateR(k)(s);
            return new Data_Tuple.Tuple(_415.value0, f(_415.value1));
        });
    };
});
var functorStateL = new Prelude.Functor(function (f) {
    return function (k) {
        return StateL.create(function (s) {
            var _418 = stateL(k)(s);
            return new Data_Tuple.Tuple(_418.value0, f(_418.value1));
        });
    };
});
...
var applyStateR = new Prelude.Apply(function (f) {
    return function (x) {
        return StateR.create(function (s) {
            var _421 = stateR(x)(s);
            var _422 = stateR(f)(_421.value0);
            return new Data_Tuple.Tuple(_422.value0, _422.value1(_421.value1));
        });
    };
}, function () {
...
var applyStateL = new Prelude.Apply(function (f) {
    return function (x) {
        return StateL.create(function (s) {
            var _427 = stateL(f)(s);
            var _428 = stateL(x)(_427.value0);
            return new Data_Tuple.Tuple(_428.value0, _427.value1(_428.value1));
        });
    };
}, function () {
