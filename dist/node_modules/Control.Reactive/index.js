...
var subscribeComputed = function (_125) {
    return function (_126) {
        return _125.value0.subscribe(_126);
    };
};
var showArrayChange = function (__dict_Show_0) {
    return new Prelude.Show(function (_129) {
        if (_129 instanceof Inserted) {
            return "Inserted " + (Prelude.show(__dict_Show_0)(_129.value0) + (" at " + Prelude.show(Prelude.showNumber)(_129.value1)));
        };
        if (_129 instanceof Updated) {
            return "Updated " + (Prelude.show(Prelude.showNumber)(_129.value1) + (" to " + Prelude.show(__dict_Show_0)(_129.value0)));
        };
        if (_129 instanceof Removed) {
            return "Removed at index " + Prelude.show(Prelude.showNumber)(_129.value0);
        };
        throw new Error("Failed pattern match");
    });
};
var semigroupSubscription = new Prelude.Semigroup(function (_127) {
...
var readComputed = function (_124) {
    return _124.value0.read;
};
...
var applyComputed = new Prelude.Apply(function (_132) {
    return function (_133) {
        return new Computed({
            read: function __do() {
                var _16 = _132.value0.read();
                var _15 = _133.value0.read();
                return _16(_15);
            }, 
            subscribe: function (ob) {
                return function __do() {
                    var _20 = _132.value0.subscribe(function (f$prime) {
                        return function __do() {
                            var _17 = _133.value0.read();
                            return ob(f$prime(_17))();
                        };
                    })();
                    var _19 = _133.value0.subscribe(function (x$prime) {
                        return function __do() {
                            var _18 = _132.value0.read();
...
var bindComputed = new Prelude.Bind(function (_130) {
    return function (_131) {
        return new Computed({
            read: function __do() {
                var _7 = _130.value0.read();
                return (function () {
                    var _507 = _131(_7);
                    return _507.value0.read;
                })()();
            }, 
            subscribe: function (ob) {
                return function __do() {
                    var _14 = _130.value0.read();
                    return (function () {
                        var _510 = _131(_14);
                        return function __do() {
                            var _13 = _510.value0.subscribe(ob)();
                            var _12 = Control_Monad_Eff_Ref_Unsafe.unsafeRunRef(Control_Monad_Eff_Ref.newRef(_13))();
                            var _11 = _130.value0.subscribe(function (a$prime) {
                                return function __do() {
                                    var _9 = Control_Monad_Eff_Ref_Unsafe.unsafeRunRef(Control_Monad_Eff_Ref.readRef(_12))();
                                    _9.value0();
                                    var _514 = _131(a$prime);
                                    Prelude[">>="](Control_Monad_Eff.bindEff)(_514.value0.read)(ob)();
                                    var _8 = _514.value0.subscribe(ob)();
