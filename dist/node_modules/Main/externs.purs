...
import Signal.Time ()
import Data.StrMap ()
newtype Component (s :: *) (e :: # !) = Component { signal :: Signal.Signal Main.Event, render :: s -> Control.Monad.Eff.Eff (reactive :: Control.Reactive.Reactive | e) Prelude.Unit, modify :: (s -> s) -> Control.Monad.Eff.Eff (reactive :: Control.Reactive.Reactive | e) Prelude.Unit, get :: Control.Monad.Eff.Eff (reactive :: Control.Reactive.Reactive | e) s, set :: s -> Control.Monad.Eff.Eff (reactive :: Control.Reactive.Reactive | e) Prelude.Unit, state :: Control.Reactive.RVar s }
...
foreign import comp2 :: forall t113. Prim.Number -> Control.Monad.Eff.Eff (reactive :: Control.Reactive.Reactive | t113) (Main.Component Prim.Number t113)
