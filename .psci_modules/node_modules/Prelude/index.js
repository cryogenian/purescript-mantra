...
var showUnit = new Show(function (_27) {
    return "Unit {}";
});
var showString = new Show(showStringImpl);
var showOrdering = new Show(function (_35) {
...
var showBoolean = new Show(function (_28) {
    if (_28) {
        return "true";
    };
    if (!_28) {
...
var semigroupUnit = new Semigroup(function (_42) {
    return function (_43) {
        return {};
    };
});
...
var eqUnit = new Eq(function (_31) {
    return function (_32) {
        return false;
    };
}, function (_29) {
...
var $less = function (__dict_Ord_11) {
    return function (a1) {
        return function (a2) {
            var _198 = compare(__dict_Ord_11)(a1)(a2);
            if (_198 instanceof LT) {
                return true;
            };
            return false;
        };
...
var $less$eq = function (__dict_Ord_12) {
    return function (a1) {
        return function (a2) {
            var _199 = compare(__dict_Ord_12)(a1)(a2);
            if (_199 instanceof GT) {
                return false;
            };
            return true;
        };
...
var $greater = function (__dict_Ord_13) {
    return function (a1) {
        return function (a2) {
            var _200 = compare(__dict_Ord_13)(a1)(a2);
            if (_200 instanceof GT) {
                return true;
            };
            return false;
        };
...
var $greater$eq = function (__dict_Ord_14) {
    return function (a1) {
        return function (a2) {
            var _201 = compare(__dict_Ord_14)(a1)(a2);
            if (_201 instanceof LT) {
                return false;
            };
            return true;
        };
...
var ordArray = function (__dict_Ord_10) {
    return new Ord(function () {
        ...
        return function (_41) {
            ...
            if (_40.length >= 1) {
                var _208 = _40.slice(1);
                if (_41.length >= 1) {
                    var _206 = _41.slice(1);
                    var _204 = compare(__dict_Ord_10)(_40[0])(_41[0]);
                    if (_204 instanceof EQ) {
                        return compare(ordArray(__dict_Ord_10))(_208)(_206);
                    };
                    return _204;
                };
            };
