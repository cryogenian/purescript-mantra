...
var hasPropertyImpl = function (_15) {
    return function (_16) {
        if (Data_Foreign.isNull(_16)) {
            return false;
        };
        if (Data_Foreign.isUndefined(_16)) {
            return false;
        };
        if (Data_Foreign.typeOf(_16) === "object" || Data_Foreign.typeOf(_16) === "function") {
            return unsafeHasProperty(_15, _16);
        };
        return false;
    };
};
...
var hasOwnPropertyImpl = function (_13) {
    return function (_14) {
        if (Data_Foreign.isNull(_14)) {
            return false;
        };
        if (Data_Foreign.isUndefined(_14)) {
            return false;
        };
        if (Data_Foreign.typeOf(_14) === "object" || Data_Foreign.typeOf(_14) === "function") {
            return unsafeHasOwnProperty(_13, _14);
        };
        return false;
    };
};
